...
public class MyDataProvider {
    ...
    @DataProvider(name = "getImportantCountries", parallel = true)
    public Object[] getImportantCountries() throws IOException {
        return JacksonUtils.deserializeJson("myImportantBillingAddresses.json", BillingAddress[].class);
    }
}
